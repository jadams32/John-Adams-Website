...
<html>
	<head>
		<title>John Adams Jr Software Developer</title>
		<meta charset="utf-8" />
						...
						<!-- Panel (Banner) -->
							<section class="panel banner right">
								<div class="content color0 span-3-75">
									<h1 class="major">Hi, i'm John.<br />
									A software engineer!</h1>
									<p>Welcome to my portfolio, where I showcase my work and you can get to know me! Poke around a bit, i'm sure you will find something interesting!</p>
									<ul class="actions">
										<li><a href="#first" class="button primary color1 circle icon solid fa-angle-right">Next</a></li>
									</ul>
								</div>
								<div class="image filtered span-1-75" data-position="25% 25%">
									<img src="images/headshotJA.jpeg" alt="" />
								</div>
							</section>
						...
						<!-- Skills Panel -->
							<section class="panel color1">
								<div class="intro joined">
									...
									<p>My tech stack was designed with the end in mind. Using languages and tools that help enterprises thrive! Certifications with AWS allow me to deploy scalable applications in the cloud.</p>
								</div>
								<div class="inner">
									<ul class="icons three">
										<li><span class="icons fab fa-python fa-3x"></span></li>
										<li><span class="icons fab fa-html5 fa-3x"></span></li>
										<li><span class="icons fab fa-css3-alt fa-3x"></span></li>
										<br></br>
										<li><span class="icons fab fa-git fa-3x"></span></li>
										<li><span class="icons fab fa-docker fa-3x"></span></li>
										<li><span class="icons fab fa-react fa-3x"></span></li>
									</ul>
								</div>
							</section>
						...
						<!-- Projects Panel -->
							<section class="panel">
								<div class="intro color2">
									...
									<p>Here I have my completed projects, hover over the image to view the source code or the live site!</p>
								</div>
								<div class="gallery">
							...
							<!-- Resume Panel (Spotlight) -->
								<section class="panel spotlight medium center" id="first">
									<div class="content span-6">
										<h2 class="major">Resume</h2>
										<p><strong>Every quality canidate needs an awesome resume. . .   <br> Heres Mine!</br></strong></p>
										<br></br>
										<a href="files/Resume.pdf" target= _"blank" class="button primary color2">Resume</a>
									</div>
							...
							<!-- About ME Panel (Spotlight) -->
								<section class="panel spotlight medium left">
									<div class="content span-7">
										<h2 class="major">What makes me so special?</h2>
										<p><strong>A graduate of Texas Tech university, I am a self starter whose able to learn quickly. My interests in software include using my code to control anything mechanical. My unqiue perspective of knowing how things operate in the physical world and computational world allow for better problem solving in an efficent manner.</strong></p>
									</div>
						...
						<!--  Contact Me Panel -->
							<section class="panel color4-alt">
								<div class="intro color4">
									...
									<p>Want to get in touch? Use this contact form, or dive even deeper into my life and coding journey via my social pages!</p>
								</div>
								<div class="inner columns divided">
									...
									<div class="span-1-3">
										<ul class="contact-icons color1">
											<li class="far fa-envelope"><a href="mailto:john.c.adams32@gmail.com">Send Email</a></li>
											<li class="icon brands fa-github"><a href="https://github.com/jadams32" Target = "_blank">GitHub</a></li>
											<li class="fab fa-linkedin"><a href="https://linkedin.com/in/john-adamsjr/" Target = "_blank">LinkedIn</a></li>
										</ul>
									</div>
								</div>
							</section>
...
print 'It took ' + i + ' iterations to sort the deck.';</code></pre>
						...
						<!-- Copyright -->
							<div class="copyright">&copy; John Adams Jr Design: <a href="https://html5up.net">HTML5 UP</a>.</div>
